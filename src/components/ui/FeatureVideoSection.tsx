...
const animationVariants: Record<string, unknown> = {
  "fade-up": {
...
const FeatureVideoSection: React.FC<FeatureVideoSectionProps> = ({
  ...
  const variants =
    animationVariants[animationType] || animationVariants["fade-up"];
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto mb-8 uppercase">
        <div className="text-sm text-blue-300 font-semibold mb-2 italic">
          {eyebrow}
        </div>
        <h2 className="text-4xl md:text-4xl font-bold italic mb-4 whitespace-pre-line">
          {title}
        </h2>
      ...
      <div className="flex justify-center">
        <video
          ...
          muted
          playsInline
          className={`w-full max-w-3xl ${videoRounded ? "rounded-2xl" : ""} ${
