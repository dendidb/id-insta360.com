    ...
    components: [
      ...
      },
      {
        ...
        options: {
          ...
          textDescription:
            "The Invisible Selfie Stick automatically disappears from your footage! Capture incredible third-person shots and drone-like angles that are impossible with other action cameras. No drone? No problem!",
          textAlign: "left",
          layout: "media-left",
          background: "bg-black",
        },
      },
      {
        ...
        options: {
          ...
          textTitle: "Shoot it\nhow you see it",
          textDescription:
            "An innovative HDR video mode that brings out the details and maintains superb stabilization for action sports. Active HDR boosts colors in the highlights and shadows that other action cameras miss.",
          textAlign: "left",
          layout: "media-right",
          background: "bg-black",
        },
      ...
      },
      {
        ...
        options: {
          ...
          buttonClassName:
            "bg-gradient-to-r from-blue-400 to-blue-200 text-black font-bold px-8 py-3 rounded-full shadow hover:from-blue-500 hover:to-blue-300 transition",
          overlay: true,
          overlayClassName:
            "flex flex-col items-start justify-center text-center inset-0 pl-12",
        },
      },
      {
        ...
        options: {
          ...
          titleClassName:
            "text-5xl font-bold italic text-white mb-12 text-center bg-gradient-to-r from-blue-400 to-blue-200 text-transparent bg-clip-text",
          background: "bg-black",
          sectionClassName: "",
          ...
          accessories: [
            ...
            },
            {
              ...
              hoverImageUrl:
                "/images/products/insta360-x4-premium-lens-guard-hover.jpg",
            ...
            },
            {
              ...
              hoverImageUrl:
                "/images/products/insta360-x4-gps-remote-hover.jpg",
            ...
            },
            {
              ...
              hoverImageUrl:
                "/images/products/insta360-x4-bike-handler-hover.jpg",
...
const ProductPage = () => {
  ...
  const [pageData, setPageData] = useState<unknown | null>(null);

  useEffect(() => {
    if (slug) {
      document.title = `Insta360 ${slug
        .toString()
        .toUpperCase()
        .replace(/-/g, " ")}`;
      // Fetch data from API (replace mockApiFetch with real fetch in production)
      mockApiFetch().then(setPageData);
    }
  }, [slug]);
    ...
    <>
      {
        ...
        pageData.components.map(
          (comp: Record<string, unknown>, idx: number) => {
            const Comp = COMPONENT_MAP[Number(comp.type)];
